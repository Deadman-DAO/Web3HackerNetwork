DELIMITER /MANGINA/
create or replace procedure `w3hacknet`.`InsertCommit` (
IN owner_id varchar(128),
IN repo_name varchar(128),
IN commit_hash char(40),
IN author_hash char(32),
IN author_alias varchar(1024),
IN date datetime,
IN orig_timezone varchar(16),
IN file_types longtext,
